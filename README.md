# ApplePushALPN （windows only）
本项目旨在为缺乏HTTP2/ALPN协议支持的旧版网络堆栈提供代理

比如你正在使用.net framework的历史版本，而无法在TLS2+ALPN上成功交互
...
- 需要使用.net8或者.net9[下载链接](https://dotnet.microsoft.com/en-us/download/dotnet/thank-you/sdk-9.0.203-windows-x64-installer "sdk-9.0.203-windows-x64-installer")编译和运行ApplePushALPN
- 客户端无此要求
